      ...
      <main>
        ...
        <section id="home" className="h-screen w-full relative flex items-center justify-center">
          ...
          <div className="relative z-10 text-center text-coffee-dark px-4">
            <h1 className="text-5xl md:text-7xl font-serif mb-4 animate-fade-in-down">Welcome to Moku Moku House</h1>
            <p className="text-lg md:text-xl animate-fade-in-up" style={{ animationDelay: '0.5s' }}>クリエイターが静かに、もくもくと創作する場所</p>
          </div>
          ...
          <AnimatedSection>
            <div className="container mx-auto px-6 text-center relative z-10">
              <div className="flex items-center justify-center mb-8">
                ...
                <h2 className="text-3xl md:text-4xl font-serif mx-8">What is Moku Moku House?</h2>
                <div className="flex-grow border-t border-coffee-light"></div>
              </div>
              <p className="max-w-3xl mx-auto text-lg leading-relaxed">
                Moku Moku Houseは、デザイナー、イラストレーター、プログラマー、ライターなど、<br />
                あらゆる分野のクリエイターが集うオンラインコミュニティです。<br />
                まるで居心地の良いカフェにいるかのように、リラックスした雰囲気の中で、<br />
        ...
        <section ref={el => addToRefs(el, 3)} id="game" className="py-20 md:py-32 bg-ivory">
          <AnimatedSection>
            <div className="container mx-auto px-6">
              <div className="max-w-2xl mx-auto p-12 border-2 border-dashed border-coffee-light rounded-lg flex flex-col items-center justify-center text-center">
